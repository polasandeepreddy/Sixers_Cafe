    ...
    <header className="bg-white shadow-md z-20 relative">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex items-center space-x-10">
          <Link to="/" className="text-lg text-gray-600 hover:text-green-600 transition-colors">
            Home
          </Link>
          <Link to="/booking" className="text-lg text-gray-600 hover:text-green-600 transition-colors">
            Book Slot
          </Link>
          <Link to="/admin" className="text-lg text-gray-600 hover:text-green-600 transition-colors">
            Admin
          </Link>
        </nav>
      </div>
